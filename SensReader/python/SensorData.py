...
class SensorData:
    ...
    def export_depth_images(self, output_path, image_size=None, frame_skip=1):
        ...
        for f in range(0, len(self.frames), frame_skip):
            ...
            imageio.imwrite(os.path.join(output_path, "depth"+ str(f).zfill(6) + ".png"), depth)
    ...
    def export_color_images(self, output_path, image_size=None, frame_skip=1):
        ...
        for f in range(0, len(self.frames), frame_skip):
            ...
            imageio.imwrite(os.path.join(output_path, "frame"+ str(f).zfill(6) + ".jpg"), color)
    ...
    def export_poses(self, output_path, frame_skip=1):
        ...
        poses = []
        for f in range(0, len(self.frames), frame_skip):
            pose_matrix = self.frames[f].camera_to_world.flatten()
            poses.append(pose_matrix)
        np.savetxt(output_path, np.array(poses))
